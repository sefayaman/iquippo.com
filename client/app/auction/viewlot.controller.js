(function() {
  ...
  function ViewLotCtrl($scope, $state,$stateParams, $rootScope, $window, categorySvc, Auth, Modal, brandSvc, LocationSvc, modelSvc, userRegForAuctionSvc, productSvc, AuctionSvc, $location, $uibModal, $sce, LotSvc) {
    var vm = this;
    ...
    $scope.auctionOrientation = $stateParams.auctionOrientation;
    var filter = {};
    $scope.equipmentSearchFilter = {};
    //$scope.mfgyr = {};
    //vm.fireCommand = fireCommand;
