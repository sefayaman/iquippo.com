...
router.post('/submitbid',auth.isAuthenticated(),controller.validateSubmitBid,controller.verifyCalculation,controller.submitBid);
...
router.get('/export',auth.isAuthenticated(), controller.getSellers, controller.getProductsList, controller.getApproverUserList, controller.exportExcel);
