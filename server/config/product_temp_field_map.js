...
module.exports = {
	...
	'Seller_Mobile_No*': 'seller_mobile',
	'Seller_Email_Address*': 'seller_email',
	//seller information start  end
	'Operating_Hours/HMR': 'operatingHour',
	'Mileage/KMR': 'mileage',
	'Machine_Serial_No': 'serialNo',
	'Product_Condition(Used/New)': 'productCondition',
	...
	'Last_Servicing_Date': 'servicedate',
	'Operating_Hours': 'serviceOperatingHour',  //will be operatingHour under serviceInfo object
	'Serviced_at(KM\'s)': 'serviceAt',
	'Service_Station_Name': 'authServiceStation',
	//service info column end
	'Engine_Repaired(Yes/No)': 'isEngineRepaired',
	'Comments': 'comment',
	'Featured': 'featured',
	//only when trade type is rent or both start
	'Rental_Negotiable(Yes/No)': 'negotiable',
	'Availability_of_Asset_From': 'fromDate',
	'Availability_of_Asset_To': 'toDate',
	'Check_Rental_Rate_For_Hours(Yes/No)': 'rateHours',
	'Check_Rental_Rate_For_Days(Yes/No)': 'rateDays',
	'Check_Rental_Rate_For_Months(Yes/No)': 'rateMonths',
	'Min_Rental_Period(Hours)': 'minPeriodH',
	'Max_Rental_Period(Hours)': 'maxPeriodH',
	'Rent_Amount_Hours': 'rentAmountH',
	'Security_Deposit_Hours': 'seqDepositH',
	'Min_Rental_Period(Days)': 'minPeriodD',
	'Max_Rental_Period(Days)': 'maxPeriodD',
	'Rent_Amount_Days': 'rentAmountD',
	'Security_Deposit_Days': 'seqDepositD',
	'Min_Rental_Period_Months': 'minPeriodM',
	'Max_Rental_Period(Months)': 'maxPeriodM',
